...
import RON.Data (ReplicatedAsObject, evalObjectState, getObject, newObjectFrame)
    ...
    cblp = SimpleUser
      { simpleUserId = Id 63495,
        ...
        simpleUserAvatarUrl = URL
                                "https://avatars0.githubusercontent.com/u/63495?v=4",
  ...
  Map.singleton "note"
    $ Map.fromList
        [ ( "000000000008K-000000000001J",
          ...
          ( "000000000008L-000000000001J",
            Map.singleton "event 3 24"
              [ "*lww #000000004L$000000000o !",
